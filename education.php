...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <title>Education Pak-Serve</title>
...
<form action="" method="GET">
                                ...
                                <form class="form-horizontal form-material">
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="course" placeholder="E.g: BS-IT"
                                                class="form-control p-0 border-0" pattern="[A-Za-z]{2,15}"
                                                title="please, enter characters between 4 and 15 in length and only letters, space not allowed. "
                                                 required> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Institute Name</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="institute" placeholder="E.g: National College"
                                                class="form-control p-0 border-0" pattern="[A-Za-z]{4,35}"
                                                title="please, enter characters between 4 and 15 in length and only letters, space not allowed. "
                                                 required> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-sm-12">Degree Duration</label>

                                        <div class="col-sm-12 border-bottom">
                                            <select class="form-select shadow-none p-0 border-0 form-control-line">
                                                <option name="duration" required >Select</option>
                                    ...
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Degree Starting Date </label>
                                        <div class="col-md-12 border-bottom p-0">
                                    ...
                                    <div class="form-group mb-4">
                                        <label for="example-email" class="col-md-12 p-0">Degree Ending Date</label>
                                        <div class="col-md-12 border-bottom p-0">
    ...
    if($_GET['submit'])
    {
        ...
        if($cors!="" && $ins!=""  && $dr!="" && $strt!="" && $end!="")
        {
            $query = "INSERT INTO education VALUES ('$cors','$ins','$dr' ,'$strt' ,'$end') ";
